...
#                atoms.append(i)
#
#            if bool(set(value)&set(case3)):
#                atoms
#                print res, value
#                if bool(set(value)&set(case1)) and 'C' not in value and 'O' not in value:
#                    print res, value, 'case1'
#                    for i in ['N','CA','H','HA','HA2','HA3']:
#                        atoms.append(i)
#                elif bool(set(value)&set(case2)) and 'N' not in value and 'H' not in value:
#                    print res, value, 'case2'
#                    for i in ['CA','C','O','HA','HA2','HA3']:
#                        atoms.append(i)
#                elif 'N' not in value and 'H' not in value and 'C' not in value and 'O' not in value:
#                    print res, value, 'case4'
#                    for i in ['CA','HA']:
#                        atoms.append(i)
#                elif bool(set(value)&set(case1)) and bool(set(value)&set(case2)):
#                    print res, value, 'case5'
#                    for i in case3:
#                        atoms.append(i)
#                else:
#                    print res, value, 'case3'
#                    for i in case3:
#                        atoms.append(i)
    return atoms
...
def write_pdb(filename,pdb,renum_atom=True,hydrogen=True,renum_res=False):
    ...
    for p in pdb:
        ...
        f.write('%6s%5d %4s%1s%3s %1s%4d%1s   %8.3f%8.3f%8.3f%6.2f%6.2f      %-4s%2s%3.1f%6s\n'%tuple(t))
    if ( file_opened ):
        f.close()
